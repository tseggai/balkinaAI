...
- For bug fixes and small changes (under 50 lines changed), commit directly to main. Only create a feature branch for full phase builds. After committing directly to main, always push immediately.
