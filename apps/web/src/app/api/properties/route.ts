...
export async function GET(request: Request) {
  ...
  const { data: campaignRows } = await supabase
    ...
    .select('id, title, blurb, description, image_url, campaign_type, starts_at, ends_at, location, is_property_only, cta_label, cta_url, cta_type, cta_fields, cta_required, cta_plus_one_limit')
